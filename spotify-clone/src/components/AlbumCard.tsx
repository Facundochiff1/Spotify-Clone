...
function AlbumCard(props: AlbumCardProps) {
    ...
    return(
        <div className="group relative p-4 flex flex-col rounded-md hover:bg-white/10 transitio duration-100">
            <div>
                <img className="w-[180px] h-[170px] object-cover rounded-[4px]" src={src} alt="Álbum image" />
